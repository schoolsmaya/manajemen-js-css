...
const NUPTK_X_POS_SG = 110; 
const NUPTK_Y_POS_SG = 750; 
const NUPTK_FONT_SIZE_SG = 10;

const NAMA_X_POS_SG = 110;
const NAMA_Y_POS_SG = 730;
const NAMA_FONT_SIZE_SG = 10; 
const NAMA_COLOR_SG = rgb(0, 0, 0); 

const NO_PESERTA_X_POS_SG = 110;
const NO_PESERTA_Y_POS_SG = 710;
const NO_PESERTA_FONT_SIZE_SG = 10;

const TAHUN_SERTIFIKASI_X_POS_SG = 110;
const TAHUN_SERTIFIKASI_Y_POS_SG = 690;
const TAHUN_SERTIFIKASI_FONT_SIZE_SG = 10;

const BIDANG_STUDI_X_POS_SG = 110;
const BIDANG_STUDI_Y_POS_SG = 670;
const BIDANG_STUDI_FONT_SIZE_SG = 10;

const NRG_X_POS_SG = 10;
const NRG_Y_POS_SG = 630;
const NRG_FONT_SIZE_SG = 8;

// --- BARU: KONFIGURASI NO. SERTIFIKAT ---
const NO_SERTIFIKAT_X_POS_SG = 160; // <--- SESUAIKAN POSISI X NO. SERTIFIKAT
const NO_SERTIFIKAT_Y_POS_SG = 720; // <--- SESUAIKAN POSISI Y NO. SERTIFIKAT (turunkan sedikit dari NRG)
const NO_SERTIFIKAT_FONT_SIZE_SG = 7;

// --- KONFIGURASI POSISI DAN UKURAN FOTO GURU ---
const PHOTO_X_POS_SG = 10; // <--- SESUAIKAN POSISI X FOTO
const PHOTO_Y_POS_SG = 600; // <--- SESUAIKAN POSISI Y FOTO
const PHOTO_WIDTH_SG = 40;  // <--- SESUAIKAN LEBAR FOTO
const PHOTO_HEIGHT_SG = 32; // <--- SESUAIKAN TINGGI FOTO
...
const generateSertifikasiPDF = async (data) => {
    try {
        ...
        firstPage.drawText(`No. Sertifikat: ${data['No. Sertifikat'] || ''}`, { 
...
function applyFilter() {
    ...
    filteredSertifikasiData = allSertifikasiData.filter(guru => {
        return (guru['NUPTK'] && String(guru['NUPTK']).toLowerCase().includes(searchTerm)) ||
               ...
               (guru['No. Sertifikat'] && String(guru['No. Sertifikat']).toLowerCase().includes(searchTerm));
    });
    currentPage = 1; 
    renderTable();
}
